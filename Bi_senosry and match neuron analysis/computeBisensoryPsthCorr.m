...
vline(median(corr_vis_com(indx_all | ~indx_all)));

% y axis histogram
figure; hold on;
hist(corr_ves_com(indx_all | ~indx_all),25);
xlim ([0 1])
vline(median(corr_ves_com(indx_all | ~indx_all)));
...
vline(median(corr_vis_com(indx_all | ~indx_all)-corr_ves_com(indx_all | ~indx_all)));
vline(0);
