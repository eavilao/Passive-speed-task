...
set(gca,'xlim', [0 450], 'ylim', [0 0.5], 'xTick', [windows], 'yTick', [0 0.25 0.5], 'TickDir', 'out','FontSize', 18);
box off
...
set(gca,'xlim', [0 450], 'ylim', [0 0.1], 'xTick', [windows], 'yTick', [0 0.05 0.1], 'TickDir', 'out','FontSize', 18);
box off
...
for i=1:length(cond)
    ...
    set(gca,'xlim', [0 5], 'ylim', [0.3 1], 'xtick',[0 1 2 3 4],'ytick',[0.3 1], 'TickDir', 'out', 'FontSize', 18);
