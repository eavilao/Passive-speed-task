...
function HeadingRaw_cum_finehd_aff_3(data, Protocol, Analysis, SpikeChan, StartEventBin, StopEventBin,StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
% at least 3 trials at each heading direction
...
writeexceldt(['Z:\Users\sheng\aferent\aff'], FILE, dt)
