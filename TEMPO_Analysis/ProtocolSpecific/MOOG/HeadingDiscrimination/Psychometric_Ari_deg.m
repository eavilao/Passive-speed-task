...
text(-0.04,1,strcat('Threshold = ','',num2str(Thresh_psy)))
text(-0.04,0.95,strcat('Threshold (degrees) = ','',num2str(convertHGrad2Slant(Thresh_psy))))
text(-0.04,0.9,strcat('Bias = ','',num2str(Bias_psy)))
text(-0.04,0.85,strcat('Bias (degrees)= ','',num2str(convertHGrad2Slant(Bias_psy))))