...
function Psychometric_FineRotDiscrm_2targ_deg(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
writeexceldt(['Z:\Users\Courtney\yawtime\behavior' ], FILE, dt);

saveas(gcf,  ['Z:\Users\Courtney\yawtime\'   FILE(1:end-4)],  'png');
close(gcf);
