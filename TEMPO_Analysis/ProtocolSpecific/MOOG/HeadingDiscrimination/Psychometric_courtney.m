...
function Psychometric_courtney(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
for i=1:length(temp_heading)
    if  unique_duration ==  1000
       [velmax maxAcc1s]=CalVel(1, 4, abs(temp_heading(i)), 0.5);
    else
