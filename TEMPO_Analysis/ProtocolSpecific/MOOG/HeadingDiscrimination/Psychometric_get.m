...
function psychdt =  Psychometric_courtney(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
psychdt = [ Bias_psy{1,1}   Thresh_psy{1,1}    m_Rsquar{1,1}];
