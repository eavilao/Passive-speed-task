...
function PURSUIT_HEADING_DISCRIM(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE);
...
unique_stim_type(isnan(unique_stim_type)) = [];
...
unique_fix_x(isnan(unique_fix_x)) = [];
...
text(40,10,'repeats =');
% text(50,10,'Pursuit heading delay =');
...
% saveas(gcf,  ['Z:\Users\Yong\pursuit\'   FILE(1:end-4)] ,  'png' );
% close(gcf);
