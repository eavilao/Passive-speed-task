...
function seperatefile2(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
for ii = 1 : Nsep
    ...
    if ii < Nsep
        ...
        Psychometric_courtney_31(data1, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, ii);
    else
